			...
			<div>
				<center>
					<form onSubmit={this.handleSubmit}>
						<input type="text" onChange={this.handleChange} value={this.state.pesanan} ref={this.pesanan} placeholder="Masukan Pesanan Anda"/>
						<input type="number" onChange={this.handleChangeJumlah} value={this.state.jumlah} placeholder="Masukan Jumlah Pesanan"/>
						<br/><br/>
